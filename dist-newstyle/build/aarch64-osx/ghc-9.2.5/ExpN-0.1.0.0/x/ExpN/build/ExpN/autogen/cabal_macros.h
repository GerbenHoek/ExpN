...
/* package ExpN-0.1.0.0 */
#ifndef VERSION_ExpN
#define VERSION_ExpN "0.1.0.0"
#endif /* VERSION_ExpN */
#ifndef MIN_VERSION_ExpN
#define MIN_VERSION_ExpN(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ExpN */
...
#define CURRENT_COMPONENT_ID "ExpN-0.1.0.0-inplace-ExpN"
