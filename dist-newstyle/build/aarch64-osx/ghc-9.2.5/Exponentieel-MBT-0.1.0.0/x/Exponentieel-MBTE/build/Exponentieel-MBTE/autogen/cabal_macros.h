...
/* package Exponentieel-MBT-0.1.0.0 */
#ifndef VERSION_Exponentieel_MBT
#define VERSION_Exponentieel_MBT "0.1.0.0"
#endif /* VERSION_Exponentieel_MBT */
#ifndef MIN_VERSION_Exponentieel_MBT
#define MIN_VERSION_Exponentieel_MBT(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Exponentieel_MBT */
...
#define CURRENT_COMPONENT_ID "Exponentieel-MBT-0.1.0.0-inplace-Exponentieel-MBTE"
